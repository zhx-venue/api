 ...
 * @example
 *	echo ConvertToPinyin::encode('阿里巴巴科技有限公司'); //编码为拼音首字母
 *	echo ConvertToPinyin::encode('阿里巴巴科技有限公司', 'all'); //编码为全拼音
 */
class ConvertToPinyin
{
     ...
     * @return string
     */
	public static function encode($utf8Data, $sRetFormat='head',$separator=' '){
